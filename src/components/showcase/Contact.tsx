...
const Contact: React.FC<ContactProps> = (props) => {
    ...
    const handleSubmit = useCallback(() => {
        if (isFormValid) {
            setIsLoading(true);
            fetch('https://mattyp.au/api/send-email', {
                method: 'POST',
                headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={igIcon}
                        link={'https://instagram.com/mattyperrott'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/mattyperrott'}
                    />
            ...
            <div className="text-block">
                <p>
                    I am currently self-employed, however if you have any
